                  ...
                  <div class="group-body simple">
                    ...
                    <details class="advanced">
                      ...
                      <div class="advanced-grid">
                        ...
                        <div class="field"><label for="clip_quality">Quality</label><select id="clip_quality" data-bind="clip.quality"><option>medium</option><option>high</option><option>very_high</option><option>ultra</option><option>40000</option></select></div>
                  ...
                  <div class="group-body simple">
                    ...
                    <details class="advanced">
                      ...
                      <div class="advanced-grid">
                        ...
                        <div class="field"><label for="record_quality">Quality</label><select id="record_quality" data-bind="record.quality"><option>medium</option><option>high</option><option>very_high</option><option>ultra</option></select></div>
